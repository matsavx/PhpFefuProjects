 ...
 */
final class Version20220420124841 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE delivery_drink (id INT AUTO_INCREMENT NOT NULL, drink_name VARCHAR(255) NOT NULL, drink_price INT NOT NULL, drink_composition VARCHAR(255) DEFAULT NULL, drink_volume INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE delivery_order (id INT AUTO_INCREMENT NOT NULL, order_kit_id INT DEFAULT NULL, order_address VARCHAR(255) DEFAULT NULL, order_session_id VARCHAR(255) DEFAULT NULL, order_client_number VARCHAR(255) DEFAULT NULL, INDEX IDX_E522750AF901703A (order_kit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE delivery_pizza (id INT AUTO_INCREMENT NOT NULL, pizza_name VARCHAR(255) NOT NULL, pizza_price INT NOT NULL, pizza_composition VARCHAR(255) DEFAULT NULL, pizza_size INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE delivery_roll (id INT AUTO_INCREMENT NOT NULL, roll_name VARCHAR(255) NOT NULL, roll_price INT NOT NULL, roll_composition VARCHAR(255) DEFAULT NULL, roll_quantity INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
