 ...
 */
class getDeliveryKitRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DeliveryKitRepository' shared autowired service.
     *
     * @return \App\Repository\DeliveryKitRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DeliveryKitRepository.php';

        return $container->privates['App\\Repository\\DeliveryKitRepository'] = new \App\Repository\DeliveryKitRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
