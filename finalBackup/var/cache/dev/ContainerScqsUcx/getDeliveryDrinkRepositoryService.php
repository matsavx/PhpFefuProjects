 ...
 */
class getDeliveryDrinkRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DeliveryDrinkRepository' shared autowired service.
     *
     * @return \App\Repository\DeliveryDrinkRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DeliveryDrinkRepository.php';

        return $container->privates['App\\Repository\\DeliveryDrinkRepository'] = new \App\Repository\DeliveryDrinkRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
