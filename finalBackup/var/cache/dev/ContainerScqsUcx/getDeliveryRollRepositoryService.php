 ...
 */
class getDeliveryRollRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DeliveryRollRepository' shared autowired service.
     *
     * @return \App\Repository\DeliveryRollRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DeliveryRollRepository.php';

        return $container->privates['App\\Repository\\DeliveryRollRepository'] = new \App\Repository\DeliveryRollRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
