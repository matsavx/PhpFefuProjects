 ...
 */
class getDeliveryPizzaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DeliveryPizzaRepository' shared autowired service.
     *
     * @return \App\Repository\DeliveryPizzaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DeliveryPizzaRepository.php';

        return $container->privates['App\\Repository\\DeliveryPizzaRepository'] = new \App\Repository\DeliveryPizzaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
